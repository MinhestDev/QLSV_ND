...
$query->execute();
    ...
    echo '<script>alert("Trang cá nhân của bạn đã được cập nhật")</script>';
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Trang cá nhân Admin </h3>
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Trang cá nhân</h4>
