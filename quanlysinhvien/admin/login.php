...
<head>
  ...
  <title>Trang đăng nhập | FBU</title>
  <!-- plugins:css -->
        ...
        <div class="row flex-grow">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left p-5">
              ...
              <h6 class="font-weight-light">Đăng nhập để tiếp tục phiên làm việc</h6>
              <form class="pt-3" id="login" method="post" name="login">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" placeholder="Nhập tên người dùng" required="true" name="username" value="<?php if (isset($_COOKIE["user_login"])) {
                ...
                <div class="my-2 d-flex justify-content-between align-items-center">
                  <div class="form-check">
                    <label class="form-check-label text-muted">
                      <input type="checkbox" id="remember" class="form-check-input" name="remember" <?php if (isset($_COOKIE["user_login"])) { ?> checked <?php } ?> /> Lưu thông tin đăng nhập </label>
                  </div>
