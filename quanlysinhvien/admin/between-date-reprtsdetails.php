...
<html lang="en">
  <head>
    ...
    <title>Báo cáo dữ liệu | FBU</title>
    <!-- plugins:css -->
...
?>
<h5 align="center" style="color:blue">Báo cáo từ ngày <?php echo $fdate?> đến ngày <?php echo $tdate?></h5>
                    </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Lớp học</th>
