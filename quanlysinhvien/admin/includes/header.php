   ...
   <div class="navbar-brand-wrapper d-flex align-items-center">
     <a class="navbar-brand brand-logo" href="dashboard.php">
       <strong style="color: white;">
         <img style="width:30px;height:30px" src="https://cdn.haitrieu.com/wp-content/uploads/2021/12/Logo-DH-Tai-chinh-Ngan-hang-Ha-Noi-FBU.png" alt="">
         QLSV | FBU
       </strong>
     </a>
     <a class="navbar-brand brand-logo-mini" href="dashboard.php"><img src="images/logo-mini.svg" alt="logo" /></a>
       ...
       <div class="navbar-menu-wrapper d-flex align-items-center flex-grow-1">
         <h5 class="mb-0 font-weight-medium d-none d-lg-flex"><?php echo htmlentities($row->AdminName); ?>: Chào mừng bạn đã quay trở lại!</h5>
         <ul class="navbar-nav navbar-nav-right ml-auto">
           ...
           <a class="dropdown-item" href="profile.php"><i class="dropdown-item-icon icon-user text-primary"></i> Trang cá nhân</a>
