                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Chọn khóa học</label>
                        <select name="section" class="form-control" required='true'>
                          <option value="">Chọn khóa học</option>
                          <option value="A">Khóa 8</option>
                          <option value="B">Khóa 9</option>
                          <option value="C">Khóa 10</option>
                          <option value="D">Khóa 11</option>
                          <option value="E">Khóa 12</option>
                          <option value="F">Khóa 13</option>
                        </select>
                      </div>
