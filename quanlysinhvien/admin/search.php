...
<html lang="en">
  <head>
    ...
    <title>Tìm kiếm sinh viên | FBU</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">Tìm sinh viên </h3>
                  ...
                  <div class="card-body">
                    <form method="post">
                                <div class="form-group">
                                   <strong>Tìm sinh viên:</strong>
                                   
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Tìm bằng mã sinh viên"></div>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">Kết quả gần nhất "<?php echo $sdata;?>" theo từ khóa </h4>
                    </div>
