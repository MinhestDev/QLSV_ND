        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Báo cáo dữ liệu </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Trang chủ</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Báo cáo dữ liệu</li>
                </ol>
              </nav>
            </div>
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Báo cáo dữ liệu</h4>
                    ...
                    <form class="forms-sample" method="post" action="between-date-reprtsdetails.php">
                     ...
                     <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-primary mr-2" name="submit">Kiểm tra</button>
